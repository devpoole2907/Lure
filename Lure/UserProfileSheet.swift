...
/// The user profile UI, shared across platforms. On macOS it's presented as
/// a fixed-size sheet with its own Done/Sign Out bottom bar; elsewhere it's
/// pushed onto the More tab's stack, so navigation chrome replaces the sheet
/// chrome and Sign Out lives in the form itself.
struct UserProfileSheet: View {
    ...
    private var profileForm: some View {
        Form {
            ...
            #if !os(macOS)
            // Pushed presentation has no bottom button bar; Sign Out lives in
            // the form instead.
            Section {
                Button(role: .destructive, action: signOut) {
                    Label("Sign Out", systemImage: "rectangle.portrait.and.arrow.right")
