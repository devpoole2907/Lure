...
/// A single colored, icon-prefixed pill shown in a detail hero (content rating,
/// availability status, file quality, etc.). Mirrors Trawl's detail badges so
/// the two apps feel familiar.
...
struct DetailBadgeSection: View {
...
// MARK: - Centered, wrapping pill layout

/// Lays pills out left-to-right, wrapping to new rows as needed, with each row
/// horizontally centered. Matches Trawl's detail badge/genre behaviour.
